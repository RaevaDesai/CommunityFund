...
class ProfileViewModel: ObservableObject {
    ...
    func setupListeners(authVM: AuthViewModel) {
        ...
        // Donated Fundraisers Listener
        db.collection("users").document(userId).addSnapshotListener { [weak self] document, error in
            ...
            let donatedIds = profile.donatedFundraisers
            
            self.donatedListener = self.db.collection("fundraisers")
